...
import { api, formatDateTime, type PolicyVersion } from "@/lib/api";
import { PageHeader } from "@/components/shared/PageHeader";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { UploadCloud, FileText, CheckCircle2, Clock, Sparkles } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="A IA usa a versão ativa para avaliar cada despesa e gerar as citações."
      />
        ...
        <Card className="shadow-sm">
          ...
          <CardContent>
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">PDF até 10 MB · a nova versão é ativada automaticamente</p>
              <Button onClick={handleUpload} disabled={mutation.isPending} className="mt-5">
            ...
            <div className="mt-4 flex items-start gap-2 rounded-lg bg-accent/40 p-3 text-sm text-accent-foreground">
              ...
              <p>
                Ao publicar, a IA reindexa as cláusulas e passa a citá-las nas próximas análises de despesas.
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            {active && (
              <div className="space-y-4">
                ...
                <div className="space-y-2 border-t border-border pt-3 text-sm">
                  <Info label="Arquivo" value={active.fileName} />
                  <Info label="Páginas" value={String(active.pages)} />
                  <Info label="Publicado por" value={active.uploadedBy} />
                  <Info label="Data" value={formatDateTime(active.uploadedAt)} />
                </div>
              </div>
            )}
          </CardContent>
